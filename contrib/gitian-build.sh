...
VERSION=
commit=false
url=https://github.com/NibexRebirth/nibex
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/NibexRebirth/nibex
...
then
    ...
    git clone https://github.com/NibexRebirth/gitian.sigs.git
    git clone https://github.com/NibexRebirth/nibex-detached-sigs.git
